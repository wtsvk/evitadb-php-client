 ...
 *
 * Generated from protobuf message <code>io.evitadb.externalApi.grpc.generated.GrpcCloseWithProgressResponse</code>
 */
class GrpcCloseWithProgressResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.io.evitadb.externalApi.grpc.generated.GrpcTransactionPhase finishedPhase = 3;</code>
     */
    protected $finishedPhase = 0;
     ...
     * @return int
     */
    public function getFinishedPhase()
    {
     ...
     * @return $this
     */
    public function setFinishedPhase($var)
    {
        GPBUtil::checkEnum($var, \Wtsvk\EvitaDbClient\Protocol\GrpcTransactionPhase::class);
        $this->finishedPhase = $var;
